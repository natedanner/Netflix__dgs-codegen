...
class ClientApiGenQueryTest {
    ...
    fun generateQueryType() {
        ...
        codeGenResult.javaQueryTypes[0].typeSpec.methodSpecs.find { it.isConstructor && it.parameters.isEmpty() }
        codeGenResult.javaQueryTypes[0].typeSpec.methodSpecs.find { it.isConstructor && (it.parameters.find { param -> param.name == "queryName" } != null) }
